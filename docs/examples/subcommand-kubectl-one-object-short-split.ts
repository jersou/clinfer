...
/*
$ ./subcommand-kubectl-one-object-short-split.ts --help
...
$ ./subcommand-kubectl-one-object-short-split.ts get --help
...
./subcommand-kubectl-one-object-short-split.ts get pod --help
...
$ ./subcommand-kubectl-one-object-short-split.ts -v=77 --token=123  get --watch=true  pod  --pod-opt 546 pod1
{
  kubectl: <ref *2> {
    v: 77,
    token: "123",
